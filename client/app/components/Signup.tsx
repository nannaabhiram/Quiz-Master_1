      ...
      <div className="max-w-md w-full bg-white rounded-lg shadow-xl p-8">
        ...
        <div className="mt-6">
          ...
          <button
            ...
            disabled={loading}
            className="mt-4 w-full flex items-center justify-center gap-2 bg-white border border-gray-300 text-gray-700 py-2 px-4 rounded-lg hover:bg-gray-50 focus:ring-4 focus:ring-gray-200 disabled:opacity-50 disabled:cursor-not-allowed font-medium"
          >
